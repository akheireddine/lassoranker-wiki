...
public class BuchiAutomizerPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				...
				new UltimatePreferenceItem<>(LABEL_ANALYSIS_TYPE_RANK, AnalysisType.LINEAR, PreferenceType.Combo,
						AnalysisType.values()),
				...
				new UltimatePreferenceItem<>(LABEL_EXTERNAL_SOLVER_COMMAND_GNTA, DEF_EXTERNAL_SOLVER_COMMAND_GNTA,
						PreferenceType.String),
				new UltimatePreferenceItem<>(LABEL_ANALYSIS_TYPE_GNTA, AnalysisType.LINEAR, PreferenceType.Combo,
						AnalysisType.values()),
